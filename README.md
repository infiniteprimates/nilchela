...
A thin, opinionated dev image for [ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw) agents — the official base, plus the [`mise`](https://github.com/jdx/mise) version manager and a clean pattern for provisioning language toolchains *at runtime* instead of baking them into the image.
